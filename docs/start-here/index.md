...
tags: ["start-here", "plain-english", "ai-basics"]
source_ids: []
claim_ids: []
---
...
Confirm the tool, account, feature and data type are approved.
</div>
...
Use the [everyday work](../everyday-charity-work/index.md) page for the task.
</div>

<div class="asc-step-card" markdown="1">
<span class="asc-step-number">4</span>

### Escalate Amber or Red

Pause before continuing where the task needs review.
</div>
...
Add new or changed AI use where your charity requires it.
</div>

<div class="asc-step-card" markdown="1">
<span class="asc-step-number">6</span>

### Know the Incident Route

Use the [AI incident route](../governance/incidents.md) if something goes wrong.
</div>
...
!!! note "Approved tool does not mean approved use"
    An AI service is approved only for the accounts, features, purposes and information recorded in your charity's approval. A new connector, agent, model, meeting feature or data source may need a fresh check.
